            ...
            <div className="lg:flex lg:justify-end">
              <div className="relative bg-[#f3f3f3] text-[14px] lg:text-[16px] p-3 rounded-xl lg:w-[400px] lg:pl-5 xl:w-[450px] xl:pl-12 xl:py-4 ">
                ...
                <span className="text-[16px] lg:text-[18px] text-justify">
                  هی رفیق، چطوری؟ فعلاً نمی‌تونم تو این دسته محصول راهنماییت کنم، ولی اصلاً نگران نباش. می‌تونی با شماره زیر تماس بگیری تا همکارای باحال ما تو فروشگاه فرهنگی کامل جوابتو بدن و هواتو داشته باشن.
                </span>
                <a
